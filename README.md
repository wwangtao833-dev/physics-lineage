...
240 个核心条目、17 个领域。支持关键词、领域、主题、时代与来源状态筛选，详情包含公式、边界条件、来源及关联条目。纯静态页面，不依赖外部脚本或在线公式渲染服务。
...
- `scripts/build-expansion.py`：第二轮 60 条补充内容的编辑入口；运行 `python3 scripts/build-expansion.py` 生成 `data-expansion.js`。
